...
ObjectDefinition.prototype.build = function(object) {
  ...
  self.required_props = _.pick(self.all_props, required);
  if (_.isEmpty(self.required_props)) self.required_props = null;
  self.optional_props = _.omit(self.all_props, required);
  if (_.isEmpty(self.optional_props)) self.optional_props = null;
